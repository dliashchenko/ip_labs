...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const mainHeader = document.getElementById("mainHeader") as
    ...
    const template = document.getElementById("task-template") as
        HTMLTemplateElement;
    const submitBtn = form.querySelector('button[type="submit"]') as
        HTMLButtonElement;
